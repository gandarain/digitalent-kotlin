...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.dicoding.mediaplayerwithserviceandnotification.mysound.mediaservice.create"
        const val ACTION_DESTROY = "com.dicoding.mediaplayerwithserviceandnotification.mysound.mediaservice.destroy"
