...
class SeatsView : View {
    ...
    // menyiapkan beberapa data yang dibutuhkan, yakni array dari kumpulan kursi yang tersedia (seats).
    init {
        seats.apply {
    ...
    // menentukan posisi X dan Y dari masing kursi yang kosong tersebut
    // menentukan beberapa titik x dan y dari masing-masing kursi
    ...
    // menyeleksi bagian yang disentuh, apakah berada dalam jangkauan kursi atau tidak
