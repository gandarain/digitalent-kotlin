package com.dicoding.clippingobjectcanvas
...
import com.dicoding.clippingobjectcanvas.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showMonkey(isSmile: Boolean) {
        showEars()
        showFace()
        showMouth(isSmile)
        showEye()
